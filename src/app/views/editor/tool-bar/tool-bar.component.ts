...
export class ToolBarComponent implements OnInit, AfterViewInit {
	...
	private tools: IToolMenu[] = [
		...
		{
			id: 'showPointCloudTool',
			label: 'PointCloud',
			class: 'toolbar-button',
			toolType: ToolType.PointCloudTool,
			action: 'point-cloud-tool',
			icon: 'blur_on',
			track: 'button',
			title: 'PointCloud Tool',
			description: 'Tool to create point clouds around road networks <br/> Use `SHIFT` + `LEFT CLICK` to create control points <br/> DRAG control points to get desired shape <br/><br/> <img src="assets/PointCloud-Tool.gif"/>',
			click: () => this.setToolType( ToolType.PointCloudTool ),
			enabled: true,
		},
		{
			id: 'vehicle',
