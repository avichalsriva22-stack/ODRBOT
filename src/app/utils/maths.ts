...
export class Maths {
	...
	public static directionV2 ( start: Vector3, end: Vector3, point: Vector3 ): TvSide {
		...
		pointVector.subVectors( point, start );

		// Calculate the vector from the start point of the line to the nearest point on the line
		const lineVector = new Vector3();
		lineVector.subVectors( start, end );
