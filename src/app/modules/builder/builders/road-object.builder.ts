...
export class RoadObjectBuilder extends MeshBuilder<TvRoadObject> {
	...
	buildRoadMarkObject ( road: TvRoad, object: TvRoadObject ): Object3D {
		...
		const roadCoord = road.getRoadPosition( object.s, object.t );
	...
	buildPoleObject ( road: TvRoad, roadObject: TvRoadObject ): Object3D {
		...
		const position = road.getRoadPosition( roadObject.s, roadObject.t );
	...
	getCornerLocalPosition ( road: TvRoad, roadObject: TvRoadObject, cornerLocal: TvCornerLocal ): Vector3 {
		...
		const position = road.getRoadPosition( s, t );
